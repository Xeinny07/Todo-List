...
export default function TodoItem({ todo, onDelete, onMarkCompleted, onEdit, }: TodoItemProps) {
  ...
  return (
    <article
      className="bg-white rounded-lg shadow-md p-4 flex flex-col gap-2 border-l-4 border-white-500 focus-within:ring-2 focus-within:ring-yellow-300"
      tabIndex={0}
