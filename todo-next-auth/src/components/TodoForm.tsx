...
export default function TodoForm({ onAdd }: TodoFormProps) {
  ...
  return (
    <section className="mb-6" aria-labelledby="add-todo-heading">
      ...
      >
        ...
        <input
          ...
          className="bg-white text-black flex border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-700"
          aria-required="true"
